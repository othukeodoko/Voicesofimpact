...
applicationForm.addEventListener('submit', async (e) => {
    ...
    try {
        ...
        // Example: await fetch('YOUR_API_ENDPOINT', { method: 'POST', body: JSON.stringify(data) })
...
// ===================================
// Confetti Effect for Modal (Optional)
// ===================================
...
document.addEventListener('DOMContentLoaded', () => {
    console.log('VOI Landing Page Initialized');
